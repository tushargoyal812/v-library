                    ...
                    <div className="card-main-section quiz-card-main">
                        ...
                        <main className="middle p-1">
                            ...
                            <div className="flex space-between mt-1">
                                <div>
                                {watchLater.some(item=>item._id===video._id)?<div className='flex'><button id="watch-later-btn" onClick={()=>RemoveWatchLaterHandler(video,setWatchLater)} className="btn start-quiz-btn quiz-bg-color flex">remove from Watch Later</button></div>:<div className='flex'><button id="watch-later-btn" onClick={()=>watchLaterHandler(video,setWatchLater)} className="btn start-quiz-btn quiz-bg-color flex"><span class="material-icons-outlined">watch_later</span><span>Watch Later</span></button></div>}
                                </div>
                            </div>
